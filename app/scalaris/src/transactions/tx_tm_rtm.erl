...
%% @end
%% @version $Id: tx_tm_rtm.erl 2817 2012-03-06 05:06:34Z kruber@zib.de $
-module(tx_tm_rtm).
-author('schintke@zib.de').
-vsn('$Id: tx_tm_rtm.erl 2817 2012-03-06 05:06:34Z kruber@zib.de $').
...
on({tp_committed, ItemId} = _Msg, State) ->
    ...
    case OrigItemResult of
        new -> State;
        _ ->
            {ItemResult, NewItemState} = tx_item_state:add_commit_ack(ItemState),
