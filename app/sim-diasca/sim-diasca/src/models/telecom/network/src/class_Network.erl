...
% (const request)
%
-spec findCommunicationPath( wooper_state(), class_Mesh:pure_node(),
...
% (oneway)
%
-spec markCommunicationPath( wooper_state(), [ class_Mesh:pure_node() ] ) ->
								   oneway_return().
...
%
-spec init_common( wooper_state(), class_Actor:actor_settings(), string(),
				  basic_utils:count() ) -> wooper_state().
