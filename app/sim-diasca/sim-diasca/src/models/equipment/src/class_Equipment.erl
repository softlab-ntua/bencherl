...
-spec construct( wooper_state(), class_Actor:actor_settings(),
				class_Actor:name(), pid(), pid() ) -> wooper_state().
...
% (actor oneway)
%
-spec setNextFailure( wooper_state(), class_TimeManager:tick_offset(), pid() )
...
% (actor oneway)
%
-spec setNextRepair( wooper_state(), class_TimeManager:tick_offset(), pid() )
					-> class_Actor:actor_oneway_return().
...
% (oneway)
%
-spec actNominal( wooper_state() ) -> oneway_return().
actNominal( State ) ->
...
% (oneway)
%
-spec actInDysfunction( wooper_state() ) -> oneway_return().
...
% (oneway)
%
-spec onFailure( wooper_state() ) -> oneway_return().
onFailure( State ) ->
...
% (oneway)
%
-spec onReparation( wooper_state() ) -> oneway_return().
onReparation( State ) ->
...
% (const request)
%
-spec getReliabilityStatus( wooper_state()) ->
...
%
-spec setReliabilityProbe( wooper_state(), pid() ) ->
...
% (helper)
%
-spec trigger_failure( wooper_state() ) -> wooper_state().
...
% (helper)
%
-spec trigger_repair( wooper_state() ) -> wooper_state().
...
% (helper)
%
-spec handle_nominal( wooper_state() ) -> wooper_state().
handle_nominal( State ) ->
...
% (helper)
%
-spec handle_dysfunction( wooper_state() ) -> wooper_state().
handle_dysfunction( State ) ->
...
% (helper)
%
-spec notify_failure( wooper_state() ) -> wooper_state().
...
% (helper)
%
-spec notify_reparation( wooper_state() ) -> wooper_state().
