...
% Three uncoupled erratic actors will be created prior to starting the
% simulation, planning to terminate at tick offsets #80, #100 and #150, whereas
% the simulation stops at #120.
%
-module(scheduling_multiple_uncoupled_erratic_actors_test).
...
run() ->
	...
	SimulationSettings = #simulation_settings{
		...
		simulation_name = "Scheduling multiple uncoupled erratic actor test"
