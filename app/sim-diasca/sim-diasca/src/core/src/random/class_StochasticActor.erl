...
-spec construct( wooper_state(), class_Actor:actor_settings(),
				class_Actor:name(), [ law_entry() ] ) -> wooper_state().
...
% (helper)
%
-spec get_random_value_from( law_identifier(), wooper_state() ) -> number().
...
% (helper)
%
-spec remove_law( law_identifier(), wooper_state() ) -> wooper_state().
