...
%
-spec construct( wooper_state(), seed_info(), boolean() ) -> wooper_state().
...
% (request)
%
-spec getUniformValue( wooper_state(), integer(), integer() ) ->
...
% (request)
%
-spec getUniformValue( wooper_state(), pos_integer() ) ->
...
% (request)
%
-spec getExponentialValue( wooper_state(), number() ) ->
...
% (request)
%
-spec getPositiveIntegerExponentialValue( wooper_state(), number() ) ->
...
% (request)
%
-spec getGaussianValue( wooper_state(), number(), number() ) ->
...
% (request)
%
-spec getPositiveIntegerGaussianValue( wooper_state(), number(), number() ) ->
...
% Displays the state of this random manager in the console.
%
...
% Returns a textual description of this random manager.
%
% (const request)
%
