...
..
	...
	3   How to Use WOOPER: Detailed Description & Concept Mappings
	  ...
	  3.3  Methods
		...
		3.3.9  Static Methods
	  3.4  State Management
		3.4.1  Principles
		3.4.2  State Implementation Details
		  3.4.2.1  Current Implementation
		  3.4.2.2  Previous Implementation
		3.4.3  Managing The State Of An Instance
		  3.4.3.1  Modifying State
			3.4.3.1.1  The ``setAttribute/3`` Function
			3.4.3.1.2  The ``removeAttribute/2`` Function
		  3.4.3.2  Reading State
			3.4.3.2.1  The ``hasAttribute/2`` Function
			3.4.3.2.2  The ``getAttribute/2`` Function
			3.4.3.2.3  The ``getAttr/2`` Macro
		  3.4.3.3  Read-Modify-Write Operations
			3.4.3.3.1  The ``addToAttribute/3`` Function
			3.4.3.3.2  The ``subtractFromAttribute/3`` Function
			3.4.3.3.3  The ``toggleAttribute/2`` Function
			3.4.3.3.4  The ``appendToAttribute/3`` Function
			3.4.3.3.5  The ``deleteFromAttribute/3`` Function
			3.4.3.3.6  The ``popFromAttribute/2`` Function
			3.4.3.3.7  The ``addKeyValueToAttribute/4`` Function
	  3.5  Multiple Inheritance & Polymorphism
		3.5.1  The General Case
		3.5.2  The Special Case of Diamond-Shaped Inheritance
	  3.6  Life-Cycle
		3.6.1  Instance Creation: ``new``/``new_link`` And ``construct``
		  ...
		  3.6.1.3  Some Examples Of Instance Creation
		  3.6.1.4  Definition of the ``construct`` Operators
		3.6.2  Instance Deletion
		  3.6.2.1  Automatic Chaining Of Destructors
		3.6.3  Asynchronous Destructor: executing ``destruct/1``
		  3.6.3.1  Synchronous Destruction: ``synchronous_delete/1``
	4   Miscellaneous Technical Points
	  4.1  ``delete_any_instance_referenced_in/2``
	  4.2  EXIT Messages
	  4.3  Practical Build Hints
	  4.4  Similarity With Other Languages
	5   WOOPER Example
	...
	7   Troubleshooting
	  7.1  General Case
		7.1.1  Compilation Warnings
		7.1.2  Runtime Errors
		  7.1.2.1  Mismatches In Method Call
			7.1.2.1.1  Oneway Versus Request Calls
			7.1.2.1.2  List Parameter Incorrectly Specified In Call
		  7.1.2.2  Error With Exit Value: ``{undef,[{hashtable,new,[..]}..``
	  7.2  For code generated by WOOPER version 2.0 and more recent
	8   Current Stable Version & Download
	  8.1  Using Stable Release Archive
	  8.2  Using Cutting-Edge SVN
	9   Version History & Changes
	  9.1  Version 2.0 [cutting-edge, in SVN only]
	  9.2  Version 1.1 [next stable]
	  9.3  Version 1.0 [current stable]
	  9.4  Version 0.4
	  9.5  Version 0.3 [current stable]
	  9.6  Version 0.2
	  9.7  Version 0.1
	10  WOOPER Inner Workings
	  10.1  Method Virtual Table
		10.1.1  General Principle
		10.1.2  Implementation In WOOPER version 2.0 and more recent
		10.1.3  Implementation In Hashtable-Based WOOPER versions
	  10.2  Attribute Table
		10.2.1  Implementation In WOOPER version 2.0 and more recent
		10.2.2  Implementation In Hashtable-Based WOOPER versions
	  10.3  Implementation
	11  Issues & Planned Enhancements
	12  Licence
	13  Sources, Inspirations & Alternate Solutions
	14  Support
	15  For WOOPER Developers
	16  Please React!
...
The WOOPER OOP concepts translate into Erlang constructs according to the following mapping:
  ...
  delete operator         WOOPER-provided function, unless user-specified as ``destruct/1`` (a.k.a. the destructor)
...
Asynchronous Destructor: executing ``destruct/1``
.................................................
...
Synchronous Destruction: ``synchronous_delete/1``
...
A class instance may receive EXIT messages from other processes, when they do not terminate normally.
