...
DIRS="$MOCK/ssi-test/src $SD/core/src/plugins $SD/core/src $SD/core/src/data-management/data-exchange $SD/core/src/data-management/data-storage $SD/core/src/deployment $SD/core/src/data-management/monitoring/performance $SD/core/src/data-management/monitoring/probe $SD/core/src/data-management/result-management $SD/core/src/random $SD/core/src/scenario $SD/core/src/scheduling $SD/core/src/resilience $SD/core/generic/src $SD/core/mesh/src $SD/core/space/src $SD/models/electricity/src $SD/models/equipment/src $SD/models/metering/src $SD/models/telecom/src $SD/models/electricity/low-voltage-mesh/src $SD/models/metering/meter/src $SD/models/metering/concentrator/src $SD/models/reliability/failure/src $SD/models/reliability/reparation/src $SD/models/telecom/interferences/src $SD/models/telecom/network/src $SD/models/telecom/point-to-point/src $SD/models/telecom/power-line-communication/src $SD/models/telecom/wireless/src $TRACES/src $MOCK/city-example/src/. $WOOPER/src $WOOPER/examples $MOCK/city-example/src/. $COMMON/src/data-management $COMMON/src/maths $COMMON/src/user-interface $COMMON/src/utils"

SD_VERSION="2.2.3-for-kostis"
