...
generate_definitions( IndustrialSourceCount, LocationGeneratorPid, GISPid ) ->
	...
	define_industrial_waste_sources( IndustrialSourceCount, GISPid, _Acc=[] ).
...
define_industrial_waste_sources( _IndustrialSourceCount=0, GISPid, Acc ) ->
...
define_industrial_waste_sources( IndustrialSourceCount, GISPid, Acc ) ->
	...
	Name = io_lib:format( "IndustrialWasteSource-~B",
						 [ IndustrialSourceCount ] ),
	...
	define_industrial_waste_sources( IndustrialSourceCount - 1, GISPid,
									NewAcc ).
...
merge_parameters( _Params=[ {  Name, ProductionType, ProductionQuantity,
	...
	merge_parameters( Tp, Tl, [ NewIndustrialSourceDef | Acc ], GISPid ).
...
to_string( State ) ->
	...
	io_lib:format( "Industrial waste source '~s' located at ~s, "
