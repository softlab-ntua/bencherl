...
%
% Typically to be run with: 'make soda_benchmarking_run', potentially with
% disabled traces, adn no performance tracker for benchmarking purposes.
...
run() ->
	...
	SimulationSettings = #simulation_settings{
	  ...
	  simulation_name = "Sim-Diasca Soda Benchmarking Test"
