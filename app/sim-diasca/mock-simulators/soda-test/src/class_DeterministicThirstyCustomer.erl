...
-define(TraceEmitterCategorization,"Soda-test.DeterministicThirstyCustomer").
...
% Attributes of a deterministic thirsty customer are:
%
...
% know
%
% - RepletionDuration is the duration, expressed in virtual minutes, of the
% period during which, once having drunk a can, this customer is not thirsty
% anymore
%
...
-spec construct( wooper_state(), class_Actor:actor_settings(),
	   class_Actor:name(), pid(), duration(), amount() ) -> wooper_state().
construct( State, ?wooper_construct_parameters ) ->

	ActorState = class_Actor:construct( State, ActorSettings, CustomerName ),
