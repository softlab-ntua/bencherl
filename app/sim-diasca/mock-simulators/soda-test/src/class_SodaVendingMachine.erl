...
% The attributes of a soda vending machine are:
%
...
-spec construct( wooper_state(), class_Actor:actor_settings(),
				class_Actor:name(), can_count(), amount() ) -> wooper_state().
...
% (actor oneway)
%
-spec getCanCost( wooper_state(), pid() ) -> class_Actor:actor_oneway_return().
