...
-spec construct( wooper_state(), class_Actor:actor_settings(),
				class_Actor:name(), age(), pid() ) -> wooper_state().
...
% (actor oneway)
%
-spec beAffected( wooper_state(), pid() ) -> class_Actor:actor_oneway_return().
...
% (actor oneway)
%
-spec deleteFromPeers( wooper_state(), pid(), pid() ) ->
							 class_Actor:actor_oneway_return().
...
% (actor oneway)
%
-spec addInPeers( wooper_state(), pid(), pid() ) ->
						class_Actor:actor_oneway_return().
