...
%
-spec construct( wooper_state(), class_Actor:actor_settings(), string(), age(),
				pid() ) -> wooper_state().
...
% (actor oneway)
%
-spec youWon( wooper_state(), pid() ) -> class_Actor:actor_oneway_return().
...
% (actor oneway)
%
-spec youLose( wooper_state(), pid() ) -> class_Actor:actor_oneway_return().
...
% (actor oneway)
%
-spec beInvited( wooper_state(), pid(), pid() ) ->
					   class_Actor:actor_oneway_return().
