...
% (static)
%
-spec send_from_test( traces:message_type(), string() ) -> basic_utils:void().
		...
		AggregatorPid ->
			...
			AggregatorPid ! { send,
				[
				 ...
				 _TraceEmitterName=
					 text_utils:string_to_binary( "Ceylan Trace Test" ),
	...
	case global:whereis_name( ?trace_aggregator_name ) of
		...
		AggregatorPid ->
			...
			AggregatorPid ! { send,
				[
				 _TraceEmitterPid=self(),
				 _TraceEmitterName=text_utils:string_to_binary( "Ceylan" ),
				 _TraceEmitterCategorization=
